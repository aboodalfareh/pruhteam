...
const getFirebaseConfig = () => {
    ...
    // create-react-app replaces process.env.REACT_APP_... with the actual value at build time.
    ...
    // The 'window' check ensures this code doesn't run in a Node.js build environment
    // and the linter doesn't complain about an undefined variable.
